...
int xsp4_spi_chan_wr_rd(int path, int chan, int region, int reg_addr, int n, u_int16_t * tx_data, u_int16_t *rx_data);
...
extern int xsp4_num_chan, xsp4_num_marker_chan;

...
drvAsynIPPortConfigure("OdinFR3Port", "localhost:4010", 100, 0, 0)
drvAsynIPPortConfigure("OdinFP3Port", "localhost:4011", 100, 0, 0)
drvAsynIPPortConfigure("OdinFR4Port", "localhost:4012", 100, 0, 0)
drvAsynIPPortConfigure("OdinFP4Port", "localhost:4013", 100, 0, 0)
